...
private:
  ...
  uint32_t txRxRFdelay; /**< Var for adjusting RFdelays depending on datarate */
...
public:
  ...
  */
   ...
   * the current configuration, the max RFdelay here is 60-70ms.
   *
...
s   *
  ...
  */
  ...
  /**
   * Set the number and RFdelay of retries upon failed submit
   *
   * @param RFdelay How long to wait between each retry, in multiples of 250us,
   * max is 15.  0 means 250us, 15 means 4000us.
   * @param count How many retries before giving up, max 15
   */
  void setRetries(uint8_t RFdelay, uint8_t count);
 ...
 *	For best settletime RFdelay value in RF24::csn() the timingSearch3pin.ino sketch can be used.         <br>
 ...
 * | gpio.h             | Provides standardized GPIO ( RFdigitalWrite() ) methods                        | 
 * | compatibility.h    | Provides standardized timing (millis(), RFdelay()) methods                     | 
