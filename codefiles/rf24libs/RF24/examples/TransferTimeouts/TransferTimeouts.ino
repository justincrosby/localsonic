...
void setup(void) {
  ...
  radio.setRetries(2,15);                  // Optionally, increase the RFdelay between retries. Want the number of auto-retries as high as possible (15)
...
void loop(void){
  ...
  if(role == TX){    
    RFdelay(2000);                                              // Pause for a couple seconds between transfers    
