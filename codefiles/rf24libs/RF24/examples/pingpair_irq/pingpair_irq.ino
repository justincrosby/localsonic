...
void setup(){
  ...
  RFpinMode(role_pin, INPUT);                        // set up the role pin                  
  RFdigitalWrite(role_pin,HIGH);                     // Change this to LOW/HIGH instead of using an external pin
