...
version 2 as published by the Free Software Foundation.
    ...
    ** Hardware configuration **
	...
	For best settletime RFdelay value in RF24::csn() the timingSearch3pin.ino scatch can be used.
...
void setup() {
  ...
  radio.setRetries(15,15); // Max RFdelay between retries & number of retries
