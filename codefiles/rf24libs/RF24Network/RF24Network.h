...
public:
 ...
 void setup_watchdog(uint8_t prescalar);
   ...
   * 2. The watchdog timer waking the MCU after a designated period of time, can also be used instead of RFdelays to control transmission intervals.
   * @code
 ...
 *
 * a: Master node configured with extended timeouts of .5 seconds, and increased retry RFdelay:
 *   @code
 * 		radio.setRetries(11,15);
 * 		network.txTimeout = 500;
 * 	 @endcode
 * b: Second leaf node configured with a similar timeout period and retry RFdelay:
 * @code
